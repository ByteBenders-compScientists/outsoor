...
export const metadata: Metadata = {
  title: 'Login',
  description: 'Sign in to your Outsoor account to access your AI APIs, dashboard, and developer tools.',
  robots: {
    index: false,
    follow: false,
  },
            ...
            <div className="hidden lg:block space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-[#E0E0E0] leading-relaxed">
                  Continue building amazing applications with the most advanced AI models through our unified platform.
                </p>
              </div>
            ...
            <div className="w-full max-w-md mx-auto lg:mx-0">
              <div className="bg-[#1A1B1F] border border-[#202126] rounded-2xl p-8 shadow-xl shadow-black/20">
                ...
                <div className="lg:hidden text-center mb-6">
                  ...
                  <p className="text-[#A0A0A8]">Sign in to your account to continue</p>
                </div>
